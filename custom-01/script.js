...
/* -----------------------------------------------------*/
document.querySelector("#main-background").style.background-image = "url('"+dataStyle.background+"')";
document.querySelector("#main-background").style.background-color = ""+dataStyle.background+"";
/* -------------------------------------------------------*/
